...
> **Карта проекта:** [НАЧНИ-ЗДЕСЬ.md](НАЧНИ-ЗДЕСЬ.md)  
> **Основной хостинг:** origonki.ru → см. [deploy/regru/README.md](deploy/regru/README.md) или кнопку **8-ДЕПЛОЙ-НА-REGRU.command**

---

# 🚀 Деплой (Render — запасной)
